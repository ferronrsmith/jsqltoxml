...
public class BinaryExpressionTreeTest {
    ...
    public void deque() {
        expressionTree.add(
                new TestExpression(
                        new StringValue("'country'"), new StringValue("'countries'")));
        expressionTree.add(
                new TestExpression(
                        new StringValue("'mountain'"), new StringValue("'caves'")));
        ...
        assertEquals(
                "country", ((StringValue) bExp.getLeftExpression()).getValue());
        assertEquals(
                "countries", ((StringValue) bExp.getRightExpression()).getValue());
